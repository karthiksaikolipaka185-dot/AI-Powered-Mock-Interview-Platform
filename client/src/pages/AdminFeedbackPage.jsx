        ...
        <div className="min-h-screen bg-background text-text-main p-4 sm:p-6 lg:p-8 transition-colors duration-300">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-wrap items-center gap-2 border-b border-border-theme pb-3">
                    ...
                    <Link
                        to="/admin/feedback"
                        className="flex items-center gap-2 text-xs sm:text-sm font-bold text-primary-theme bg-primary-theme/10 border border-primary-theme/20 px-3 py-2 rounded-xl relative"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="glass p-5 rounded-2xl border border-border-theme shadow-sm flex items-center justify-between">
                        <div>
                            <span className="text-xs font-bold text-text-secondary block">Average Rating</span>
                    ...
                    <div className="glass p-5 rounded-2xl border border-border-theme shadow-sm flex items-center justify-between">
                        <div>
                            <span className="text-xs font-bold text-text-secondary block">Total Feedback</span>
                    ...
                    <div className="glass p-5 rounded-2xl border border-border-theme shadow-sm flex items-center justify-between">
                        <div>
                            <span className="text-xs font-bold text-text-secondary block">Positive Reviews</span>
                    ...
                    <div className="glass p-5 rounded-2xl border border-border-theme shadow-sm flex items-center justify-between">
                        <div>
                            <span className="text-xs font-bold text-text-secondary block">Pending Reviews</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="glass p-6 rounded-2xl border border-border-theme shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-[11px] text-text-secondary font-medium">Breakdown</span>
                        </div>
                        <div className="h-56">
                    ...
                    <div className="glass p-6 rounded-2xl border border-border-theme shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-[11px] text-text-secondary font-medium">Submissions</span>
                        </div>
                        <div className="h-56">
                            <ResponsiveContainer width="100%" height="100%">
                    ...
                    <div className="glass p-6 rounded-2xl border border-border-theme shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-[11px] text-text-secondary font-medium">Top Voted</span>
                        </div>
                        <div className="h-56">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={charts?.favoriteFeatures || []} layout="vertical">
                                    ...
                                    <YAxis dataKey="feature" type="category" stroke="var(--text-secondary)" fontSize={10} width={90} />
                                    <Tooltip contentStyle={{ backgroundColor: 'var(--card)', borderColor: 'var(--border)', color: 'var(--text)', borderRadius: '12px' }} />
                ...
                <div className="glass rounded-2xl border border-border-theme shadow-sm overflow-hidden">
                    <div className="p-4 border-b border-border-theme flex items-center justify-between">
                        ...
                        <span className="text-[11px] text-text-secondary italic">Click any feedback row to inspect full AI sentiment & suggestion</span>
                    </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-border-theme text-xs sm:text-sm">
                                {loading ? (
                                    <tr>
                                        <td colSpan={6} className="py-12 text-center">
                                            <div className="flex flex-col items-center gap-2">
                                                ...
                                                <span className="text-xs text-text-secondary">Loading candidate feedback...</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    feedbackList.map(f => (
                                        ...
                                        >
                                            ...
                                            <td className="py-3.5 px-4">
                                                <span className="font-bold text-text-main block">{f.userName}</span>
                                                <span className="text-[11px] text-text-secondary font-normal">{f.userEmail}</span>
                                            </td>
                                            <td className="py-3.5 px-4 font-medium text-text-main">
                                                {f.favoriteFeature}
                                            </td>
                                            <td className="py-3.5 px-4 text-text-secondary max-w-xs truncate italic">
                                                "{f.suggestionPreview}"
                                            </td>
                                    ...
                                    <tr>
                                        <td colSpan={6} className="py-8 text-center text-text-secondary/60 text-xs">
